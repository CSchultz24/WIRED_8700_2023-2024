...
public final class FieldConstants2023 {
  ...
  public static final class LoadingZone {
    ...
    public static final double innerX = FieldConstants2023.fieldLength;
    ...
    public static final double leftY = FieldConstants2023.fieldWidth;
    ...
    public static final double singleSubstationLeftX =
        FieldConstants2023.fieldLength - doubleSubstationLength - Units.inchesToMeters(88.77);
   ...
   * default, all translations and poses in {@link FieldConstants2023} are stored with the origin at the
   ...
   * all translations and poses in {@link FieldConstants2023} are stored with the origin at the
   * rightmost point on the BLUE ALLIANCE wall.
   */
